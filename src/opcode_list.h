// TOP is a marker instruction
// it won't be present in the bytecode
// please keep it as the first member of this list,
// so as to receive the instruction code 0
OP(TOP, MARKER, 0, 0)
...
OP(BACKTRACK_N, BT(CONSTANT), 0, 0)
OP(BACKTRACK_0, BT(NONE), 0, 0)
OP(RAISE, BT(NONE), 1, 0)
...
// a real noop for empty handlers
OP(TARGET_MARKER, MARKER, 0, 0)
...
OP(DESTRUCTURE_ALT, DEFINITION, 0, 0)
OP(DESTRUCTURE_BEGIN, VARIABLE, 0, 0)
OP(PROTECT, BRANCH, 0, 0)
